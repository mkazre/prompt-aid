...
/**
 * Third parties (lab/diagnostics and other service partners) only — their
 * own queue, requests and results. Kept separate from /staff so a partner
 * never sees a clinical navigation tree.
 */
class PartnerPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->font('Lato')
            ->resources([
                LabRequestResource::class,
                ThirdPartyProfileResource::class,
            ])
            ->pages([
                Dashboard::class,
            ])
